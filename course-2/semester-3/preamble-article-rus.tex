\documentclass[a4paper,14pt]{article} % format of document
...
\geometry{top=20mm}    % top field
\geometry{bottom=20mm} % bottom field
\geometry{left=30mm}   % left field
\geometry{right=10mm}  % right field

\linespread{1.5}               % length between str
\setlength{\parindent}{12,5mm} % red str
